...
for index,item in dataframe.iterrows():
    ...
    #    offset=1123,1073
        ...
        if item['pos']==1:
            ...
            suf='th'
        f = open(f"./Winner/{name_wo_spc}-{item['email']}.html",'w')
                ...
                if f"{name_wo_spc}-{item['email']}.jpg"==filename:
                    ...
                    contents = [
                        f'''Dear Participant, 
                                ...
                                Congratulations on securing {item['pos']}{suf} position in the event {item['event']} by Petrichor'23 . This is the attached certificate of achievement.
                    ...
                    yag.send(f'{email}', f"Petrichor'23: {item['event']}  Certificate of Achievement", contents)
                    current_mail_no+=1
